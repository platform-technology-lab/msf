...
public class ClientExampleController {
    ...
    public String listEmployee(Model model) {
    	Employee[] employees = employeeClient.getForObject("http://basic:8012/employees",Employee[].class);
    ...
    public String Infoemployee(Model model, @PathVariable("empNo") String empNo) {
    	Employee employee = employeeClient.getForObject("http://basic:8012/employee/"+empNo, Employee.class);
    ...
    public String addEmployee(@ModelAttribute UIData uiData, Model model, @PathVariable("action") String action) throws RestClientException, UnsupportedEncodingException {
    	if (action.equals("ADD"))
    	 employeeClient.postForObject("http://basic:8012/employee", uiData.getEmployee(), Employee.class);
    	else
    	 employeeClient.put("http://basic:8012/employee", uiData.getEmployee());	
    ...
    public String delEmployee(Model model,@PathVariable("empNo") String empNo) {
    	employeeClient.delete("http://basic:8012/employee/"+empNo); 
        return "redirect:/emplist";
    }
